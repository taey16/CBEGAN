...
parser.add_argument('--cond_size', type=int, default=0,  help='Whether to use conditional GAN')
...
netG = net.Decoder(inputChannelSize, ngf, opt.hidden_size, True, opt.cond_size)
netG.apply(weights_init)
if opt.netG != '':
  netG.load_state_dict(torch.load(opt.netG))
print(netG)
netD = net.D(inputChannelSize, ndf, ndf, opt.hidden_size, True, opt.cond_size)
